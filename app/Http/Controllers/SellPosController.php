...
class SellPosController extends Controller
{
    ...
    public function __construct(
        ...
        'is_return' => 0, 'transaction_no' => '', 'vencimento' => '', 'data_base' => '', 
        'intervalo' => '', 'vencimento' => date('d/m/Y'), 'qtd_parcelas' => 1];
    }
...
if (!$is_direct_sale) {
    ...
    private function receiptContent(
        ...
        if ($receipt_printer_type == 'printer') {
            ...
            $output['html_content'] = view($layout, compact('receipt_details', 'cliente'))->render();
        }
...
if (!$is_direct_sale) {
    ...
    public function getProductRow($variation_id, $location_id)
    {
        ...
        try {
            ...
            $output['success'] = false;
            $output['msg'] = __('lang_v1.item_out_of_stock') . "123";
        }
