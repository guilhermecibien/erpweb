...
class SuperadminServiceProvider extends ServiceProvider
{
    ...
    public function registerViews()
    {
        ...
        $publishedViewPaths = array_filter(array_map(function ($path) {
            return $path . '/modules/superadmin';
        }, \Config::get('view.paths')), 'is_dir');

        $this->loadViewsFrom(array_merge($publishedViewPaths, [$sourcePath]), 'superadmin');
    }
