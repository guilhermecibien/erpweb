@php
$__f1 = ['options' => ['url' => action('PaymentController@paymentBoleto'), 'method' => 'post', 'id' => 'form_boleto' ]];
@endphp
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            @php
            $__f11 = ['name' => 'docType', 'list' => [], 'selected' => '', 'options' => ['class' => 'form-control', 'id' => 'docType2', 'required', 'data-checkout' => 'docType']];
            @endphp
