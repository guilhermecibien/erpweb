            ...
            <div class="col-md-5 col-sm-5 hidden-xs left-col eq-height-col" >
                <div class="left-col-content login-header">
                    <div>
                        ...
                        <p class="tagline">Gestão simples e organizada para o seu negócio, em um só lugar.</p>
                        @endif
                    </div>
                </div>
            </div>
            <div class="col-md-7 col-sm-7 col-xs-12 right-col eq-height-col">
                <div class="row">
                    ...
                    <div class="col-md-9 col-xs-8" style="text-align: right;padding-top: 10px;">
                        ...
                        @endif
                        @endif
                        &nbsp; &nbsp;<span class="text-muted">{{ __('business.already_registered')}} </span><a href="{{ action('Auth\LoginController@login') }}@if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif">Login</a>
                        @endif
                    </div>
