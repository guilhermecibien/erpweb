...
<section class="content">
  ...
  @php
  $__f1 = ['options' => ['url' => action('CteController@update'), 'method' => 'post', 'id' => 'cte_update_form' ]];
  @endphp
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          @php
          $__f3 = ['name' => 'natureza_id', 'list' => $naturezas, 'selected' => $cte->natureza_id, 'options' => ['class' => 'form-control select2', 'id' => 'contact_type', 'required']];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          ...
          @php
          $__f5 = ['name' => 'globalizado', 'list' => ['0' => 'Não', 1 => 'Sim'], 'selected' => $cte->globalizado, 'options' => ['class' => 'form-control select2', 'id' => 'contact_type', 'required']];
          @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          @php
          $__f7 = ['name' => 'cst', 'list' => App\Models\Cte::getCsts(), 'selected' => $cte->cst, 'options' => ['class' => 'form-control select2', 'id' => 'contact_type', 'required']];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          ...
          @php
          $__f9 = ['name' => 'perc_icms', 'value' => $cte->perc_icms, 'options' => ['class' => 'form-control type-ref', 'placeholder' => '%ICMS', 'data-mask="00,00", data-mask-reverse="true"' ]];
          @endphp
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          @php
          $__f12 = ['name' => 'remetente_id', 'list' => $clientes, 'selected' => $cte->remetente_id, 'options' => ['class' => 'form-control select2', 'id' => 'remetente_id', 'required', 'placeholder' => 'Selecione o remetente']];
          @endphp
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          @php
          $__f14 = ['name' => 'destinatario_id', 'list' => $clientes, 'selected' => $cte->destinatario_id, 'options' => ['class' => 'form-control select2', 'id' => 'destinatario_id', 'required', 'placeholder' => 'Selecione o destinatário']];
          @endphp
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        @php
                        $__f16 = ['name' => 'tpDoc', 'list' => $tipos, 'selected' => $cte->tpDoc, 'options' => ['class' => 'form-control', 'id' => 'tpDoc', 'required']];
                        @endphp
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        @php
                        $__f18 = ['name' => 'descOutros', 'value' => $cte->descOutros, 'options' => ['class' => 'form-control type-ref', 'placeholder' => 'Descrição do Doc.' ]];
                        @endphp
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        @php
                        $__f20 = ['name' => 'nDoc', 'value' => $cte->nDoc, 'options' => ['class' => 'form-control type-ref', 'placeholder' => 'Numero do Doc.' ]];
                        @endphp
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        @php
                        $__f22 = ['name' => 'vDocFisc', 'value' => $cte->vDocFisc, 'options' => ['class' => 'form-control type-ref', 'placeholder' => 'Valor do Documento', 'data-mask="000000,00", data-mask-reverse="true"' ]];
                        @endphp
      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          @php
          $__f24 = ['name' => 'veiculo_id', 'list' => $veiculos, 'selected' => $cte->veiculo_id, 'options' => ['class' => 'form-control select2', 'id' => 'veiculo_id', 'required', 'placeholder' => 'Veiculo']];
          @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          @php
          $__f26 = ['name' => 'prod_predominante', 'value' => $cte->produto_predominante, 'options' => ['class' => 'form-control type-ref', 'required', 'placeholder' => 'Produto predominante' ]];
          @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          @php
          $__f28 = ['name' => 'tomador', 'list' => $tiposTomador, 'selected' => $cte->tomador, 'options' => ['class' => 'form-control select2', 'id' => 'tomador', 'required']];
          @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          @php
          $__f30 = ['name' => 'valor_carga', 'value' => $cte->valor_carga, 'options' => ['class' => 'form-control', 'required type-ref', 'placeholder' => 'Valor da Carga', 'data-mask="000000,00", data-mask-reverse="true"' ]];
          @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          @php
          $__f32 = ['name' => 'modal_transp', 'list' => $modals, 'selected' => $cte->modal_transp, 'options' => ['class' => 'form-control select2', 'id' => 'modal_transp', 'required']];
          @endphp
      ...
      <div class="col-md-5">
        <div class="form-group">
          ...
          @php
          $__f44 = ['name' => 'rua_tomador', 'value' => $cte->logradouro_tomador, 'options' => ['class' => 'form-control type-ref', 'required', 'placeholder' => 'Rua' ]];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          ...
          @php
          $__f46 = ['name' => 'numero_tomador', 'value' => $cte->numero_tomador, 'options' => ['class' => 'form-control type-ref', 'required', 'placeholder' => 'Número' ]];
          @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          @php
          $__f48 = ['name' => 'cep_tomador', 'value' => $cte->cep_tomador, 'options' => ['class' => 'form-control type-ref', 'required', 'placeholder' => 'CEP' ]];
          @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          @php
          $__f50 = ['name' => 'bairro_tomador', 'value' => $cte->bairro_tomador, 'options' => ['class' => 'form-control type-ref', 'required', 'placeholder' => 'Bairro' ]];
          @endphp
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          @php
          $__f52 = ['name' => 'cidade_tomador', 'list' => $cidades, 'selected' => $cte->municipio_tomador, 'options' => ['class' => 'form-control select2', 'id' => 'cidade_tomador', 'required']];
          @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            @php
            $__f54 = ['name' => 'data_prevista_entrega', 'value' => \Carbon\Carbon::parse($cte->data_previsata_entrega)->format('d/m/Y'), 'options' => ['class' => 'form-control', 'readonly', 'required', 'id' => 'vencimento']];
            @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          @php
          $__f56 = ['name' => 'valor_transporte', 'value' => number_format($cte->valor_transporte, 2, ',', ''), 'options' => ['class' => 'form-control type-ref', 'required', 'placeholder' => 'Valor da Prestação de Serviço', 'data-mask="000000,00", data-mask-reverse="true"' ]];
          @endphp
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          @php
          $__f58 = ['name' => 'valor_receber', 'value' => $cte->valor_receber, 'options' => ['class' => 'form-control', 'required type-ref', 'placeholder' => 'Valor a Receber', 'data-mask="000000,00", data-mask-reverse="true"' ]];
          @endphp
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          @php
          $__f60 = ['name' => 'cidade_envio', 'list' => $cidades, 'selected' => $cte->municipio_envio, 'options' => ['class' => 'form-control select2', 'id' => 'cidade_envio', 'required']];
          @endphp
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          @php
          $__f62 = ['name' => 'cidade_inicio', 'list' => $cidades, 'selected' => $cte->municipio_inicio, 'options' => ['class' => 'form-control select2', 'id' => 'cidade_inicio', 'required']];
          @endphp
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          @php
          $__f64 = ['name' => 'cidade_fim', 'list' => $cidades, 'selected' => $cte->municipio_fim, 'options' => ['class' => 'form-control select2', 'id' => 'cidade_fim', 'required']];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          ...
          @php
          $__f66 = ['name' => 'retira', 'list' => [1 => 'sim', 0 => 'não'], 'selected' => $cte->retira, 'options' => ['class' => 'form-control select2', 'id' => 'retira', 'required']];
          @endphp
      ...
      <div class="col-md-5">
        <div class="form-group">
          ...
          @php
          $__f68 = ['name' => 'detalhes_retira', 'value' => $cte->detalhes_retira, 'options' => ['class' => 'form-control type-ref', 'placeholder' => 'Detalhes(opcional)' ]];
          @endphp
      ...
      <div class="col-md-7">
        <div class="form-group">
          ...
          @php
          $__f70 = ['name' => 'obs', 'value' => $cte->observacao, 'options' => ['class' => 'form-control type-ref', 'placeholder' => 'Informação Adicional' ]];
          @endphp
