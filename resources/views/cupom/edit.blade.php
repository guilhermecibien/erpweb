...
<section class="content">
  @php
  $__f1 = ['options' => ['url' => action('CupomController@update'), 'method' => 'post', 'id' => 'natureza_add_form' ]];
  @endphp
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            @php
            $__f3 = ['name' => 'codigo', 'value' => $cupom->codigo, 'options' => ['class' => 'form-control', 'required', 'placeholder' => 'Código', 'data-mask="AAAAAA"', 'data-mask-reverse="true"' ]];
            @endphp
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          @php
          $__f5 = ['name' => 'valor', 'value' => $cupom->valor, 'options' => ['class' => 'form-control', 'placeholder' => 'Valor', 'required',  'data-mask="000000,00"', 'data-mask-reverse="true"']];
          @endphp
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          @php
          $__f7 = ['name' => 'tipo', 'list' => ['percentual' => 'Percentual', 'valor' => 'Valor'], 'selected' => $cupom->tipo, 'options' => ['class' => 'form-control']];
          @endphp
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          <label style="margin-top: 5px;">
            @php
            $__f8 = ['name' => 'status', 'value' => 1, 'checked' => $cupom->status, 'options' => ['class' => 'input-icheck', 'id' => 'status']];
            @endphp
