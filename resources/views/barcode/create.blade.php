...
@php
$__f1 = ['options' => ['url' => action('BarcodeController@store'), 'method' => 'post', 'id' => 'add_barcode_settings_form' ]];
@endphp
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <x-form.label :name="$__f2['name']" :value="$__f2['value']" />
              @php
              $__f3 = ['name' => 'name', 'value' => null, 'options' => ['class' => 'form-control', 'required', 'placeholder' => __('barcode.setting_name')]];
              @endphp
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <x-form.label :name="$__f4['name']" :value="$__f4['value']" />
              @php
              $__f5 = ['name' => 'description', 'value' => null, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.setting_description'), 'rows' => 3]];
              @endphp
        ...
        <div class="col-sm-12">
          <div class="form-group">
            <div class="checkbox">
              <label>
                @php
                $__f6 = ['name' => 'is_continuous', 'value' => 1, 'checked' => false, 'options' => ['id' => 'is_continuous']];
                @endphp
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
              $__f8 = ['name' => 'top_margin', 'value' => 0, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.top_margin'), 'min' => 0, 'step' => 0.00001, 'required']];
              @endphp
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
              $__f10 = ['name' => 'left_margin', 'value' => 0, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.left_margin'), 'min' => 0, 'step' => 0.00001, 'required']];
              @endphp
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
              $__f12 = ['name' => 'width', 'value' => null, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.width'), 'min' => 0.1, 'step' => 0.00001, 'required']];
              @endphp
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
              $__f14 = ['name' => 'height', 'value' => null, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.height'), 'min' => 0.1, 'step' => 0.00001, 'required']];
              @endphp
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
              $__f16 = ['name' => 'paper_width', 'value' => null, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.paper_width'), 'min' => 0.1, 'step' => 0.00001, 'required']];
              @endphp
        ...
        <div class="col-sm-6 paper_height_div">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
              $__f18 = ['name' => 'paper_height', 'value' => null, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.paper_height'), 'min' => 0.1, 'step' => 0.00001, 'required']];
              @endphp
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
              $__f20 = ['name' => 'stickers_in_one_row', 'value' => null, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.stickers_in_one_row'), 'min' => 1, 'required']];
              @endphp
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
              $__f22 = ['name' => 'row_distance', 'value' => 0, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.row_distance'), 'min' => 0, 'step' => 0.00001, 'required']];
              @endphp
          ...
          <div class="form-group">
            ...
            <x-form.label :name="$__f23['name']" :value="$__f23['value']" />
             <div class="input-group">
              ...
              @php
              $__f24 = ['name' => 'col_distance', 'value' => 0, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.col_distance'), 'min' => 0, 'step' => 0.00001, 'required']];
              @endphp
        ...
        <div class="col-sm-6 stickers_per_sheet_div">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              @php
              $__f26 = ['name' => 'stickers_in_one_sheet', 'value' => null, 'options' => ['class' => 'form-control', 'placeholder' => __('barcode.stickers_in_one_sheet'), 'min' => 1, 'required']];
              @endphp
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                @php
                $__f27 = ['name' => 'is_default', 'value' => 1];
                @endphp
                <x-form.checkbox :name="$__f27['name']" :value="$__f27['value']" /> @lang('barcode.set_as_default')</label>
              </div>
          </div>
        </div>
        <div class="col-sm-12">
