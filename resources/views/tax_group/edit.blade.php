<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    @php
    $__f1 = ['options' => ['url' => action('GroupTaxController@update', [$tax_rate->id]), 'method' => 'PUT', 'id' => 'tax_group_edit_form' ]];
    @endphp
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <x-form.label :name="$__f4['name']" :value="$__f4['value']" />
          @php
          $__f5 = ['name' => 'taxes[]', 'list' => $taxes, 'selected' => $sub_taxes, 'options' => ['class' => 'form-control select2', 'required', 'multiple']];
          @endphp
