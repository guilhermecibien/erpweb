  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-12">
        ...
        <h4>Chave NF-e Gerada: <strong>{{$devolucao->chave_gerada}}</strong></h4>
        <h4>Número NF-e Gerada: <strong>{{$devolucao->numero_gerado}}</strong></h4>
      ...
      <div class="col-md-12">
        ...
        <a class="btn btn-lg btn-primary" target="_blank" href="/devolucao/imprimirCorrecao/{{$devolucao->id}}" id="submit_user_button">Imprimir CCe</a>
        @endif
  ...
  <div class="row" id="action" style="display: none">
    ...
    <script type="text/javascript">
      ...
      $('#corrigir').click(() => {
        ...
        swal({
          text: 'Carta de correção devolução para NF-e '+numero_nfe+'.',
          content: "input",
          button: {
            text: "Corrigir!",
            closeModal: false,
