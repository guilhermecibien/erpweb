<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    @php
    $__f1 = ['options' => ['url' => action('AccountController@store'), 'method' => 'post', 'id' => 'payment_account_form' ]];
    @endphp
  ...
  <div class="modal-body">
    ...
    <div class="form-group">
        ...
        @php
        $__f5 = ['name' => 'account_number', 'value' => null, 'options' => ['class' => 'form-control', 'required','placeholder' => __( 'account.account_number' ) ]];
        @endphp
    ...
    <div class="form-group">
        @php
        $__f7 = ['name' => 'opening_balance', 'value' => __( 'account.opening_balance' ) .":"];
        @endphp
        <x-form.label :name="$__f7['name']" :value="$__f7['value']" />
        @php
        $__f8 = ['name' => 'opening_balance', 'value' => 0, 'options' => ['class' => 'form-control input_number','placeholder' => __( 'account.opening_balance' ) ]];
        @endphp
