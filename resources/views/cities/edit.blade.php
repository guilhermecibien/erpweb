...
<section class="content sa-dashboard">
    ...
    <div class="sa-page-card">
        <div class="sa-page-card-body sa-business-form">
            @php
            $__f1 = ['options' => ['url' => action('CityController@update'), 'method' => 'post', 'id' => 'natureza_add_form' ]];
            @endphp
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        @php
                        $__f7 = ['name' => 'codigo', 'value' => $city->codigo, 'options' => ['class' => 'form-control', 'required', 'placeholder' => 'Código' ]];
                        @endphp
