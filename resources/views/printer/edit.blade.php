...
@php
$__f1 = ['options' => ['url' => action('PrinterController@update', [$printer->id]), 'method' => 'PUT', 'id' => 'add_printer_form' ]];
@endphp
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <x-form.label :name="$__f2['name']" :value="$__f2['value']" />
              @php
              $__f3 = ['name' => 'name', 'value' => $printer->name, 'options' => ['class' => 'form-control', 'required', 'placeholder' => __('lang_v1.printer_name_help')]];
              @endphp
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            @php
            $__f5 = ['name' => 'connection_type', 'list' => $connection_types, 'selected' => $printer->connection_type, 'options' => ['class' => 'form-control select2']];
            @endphp
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            @php
            $__f7 = ['name' => 'capability_profile', 'list' => $capability_profiles, 'selected' => $printer->capability_profile, 'options' => ['class' => 'form-control select2']];
            @endphp
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <x-form.label :name="$__f8['name']" :value="$__f8['value']" />
              @php
              $__f9 = ['name' => 'char_per_line', 'value' => $printer->char_per_line, 'options' => ['class' => 'form-control', 'required', 'placeholder' => __('lang_v1.char_per_line_help')]];
              @endphp
        ...
        <div class="col-sm-12" id="ip_address_div">
          <div class="form-group">
            ...
            <x-form.label :name="$__f10['name']" :value="$__f10['value']" />
              @php
              $__f11 = ['name' => 'ip_address', 'value' => $printer->ip_address, 'options' => ['class' => 'form-control', 'required', 'placeholder' => __('lang_v1.ip_address_help')]];
              @endphp
        ...
        <div class="col-sm-12" id="port_div">
          <div class="form-group">
            ...
            <x-form.label :name="$__f12['name']" :value="$__f12['value']" />
              @php
              $__f13 = ['name' => 'port', 'value' => $printer->port, 'options' => ['class' => 'form-control', 'required']];
              @endphp
        ...
        <div class="col-sm-12 hide" id="path_div">
          <div class="form-group">
            ...
            @php
            $__f15 = ['name' => 'path', 'value' => $printer->path, 'options' => ['class' => 'form-control', 'required']];
            @endphp
