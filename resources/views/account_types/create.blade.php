<div class="modal-dialog" role="document">
    ...
    @php
    $__f1 = ['options' => ['url' => action('AccountTypeController@store'), 'method' => 'post', 'id' => 'account_type_form' ]];
    @endphp
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        	...
        	<x-form.label :name="$__f4['name']" :value="$__f4['value']" />
          	@php
          	$__f5 = ['name' => 'parent_account_type_id', 'list' => $account_types->pluck('name', 'id'), 'selected' => null, 'options' => ['class' => 'form-control', 'placeholder' => __( 'messages.please_select' )]];
          	@endphp
