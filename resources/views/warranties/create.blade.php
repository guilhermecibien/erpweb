<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    @php
    $__f1 = ['options' => ['url' => action('WarrantyController@store'), 'method' => 'post', 'id' => 'warranty_form']];
    @endphp
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
          @php
          $__f7 = ['name' => 'duration', 'value' => null, 'options' => ['class' => 'form-control width-40 pull-left', 'placeholder' => __( 'lang_v1.duration' ), 'required' ]];
          @endphp
          <x-form.input type="number" :name="$__f7['name']" :value="$__f7['value']" :options="$__f7['options']" />

          @php
          $__f8 = ['name' => 'duration_type', 'list' => ['days' => __('lang_v1.days'), 'months' => __('lang_v1.months'), 'years' => __('lang_v1.years')], 'selected' => '', 'options' => ['class' => 'form-control width-60 pull-left','placeholder' => __('messages.please_select'), 'required']];
          @endphp
