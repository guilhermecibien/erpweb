  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-5">
        ...
        <h4>Ultimo numero MDF-e: <strong>{{$mdfe->lastMDFe($mdfe)}}</strong></h4>
      ...
      <div class="col-md-12">
        <a class="btn btn-lg btn-warning" target="_blank" href="/mdfe/edit/{{$mdfe->id}}" id="submit_user_button">Editar</a>
        <a class="btn btn-lg btn-primary" target="_blank" href="/mdfe/renderizar/{{$mdfe->id}}" id="submit_user_button">Renderizar</a>

        <a class="btn btn-lg btn-danger" target="_blank" href="/mdfe/gerarXml/{{$mdfe->id}}" id="submit_user_button">Gerar XML</a>
    ...
    <script type="text/javascript">
      ...
      $('#send-sefaz').click(() => {
        ...
        ({
          ...
          url: path + '/mdfe/transmitir',
          dataType: 'json',
          success: function(e){
            console.log(e)

            swal("sucesso", "MDF-e emitida, chave: " + e.chave + " | Protocolo: " + e.protocolo, "success")
            .then(() => {
              window.open(path + '/mdfe/imprimir/'+id)
              location.reload()
            });
