...
<section class="content">
  @php
  $__f1 = ['options' => ['url' => action('BoletoController@store'), 'method' => 'post', 'id' => 'boleto_form' ]];
  @endphp
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f2 = ['name' => 'valor', 'value' => 'Valor' . '*:'];
          @endphp
          <x-form.label :name="$__f2['name']" :value="$__f2['value']" />
          @php
          $__f3 = ['name' => 'valor', 'value' => number_format($revenue->valor_total, 2, ',', '.'), 'options' => ['class' => 'form-control', 'required', 'readonly']];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          ...
          @php
          $__f5 = ['name' => 'vencimento', 'value' => \Carbon\Carbon::parse($revenue->vencimento)->format('d/m/Y'), 'options' => ['class' => 'form-control', 'required', 'readonly']];
          @endphp
      ...
      <div class="col-md-4">
        <div class="form-group">
          @php
          $__f6 = ['name' => 'banco', 'value' => 'Banco' . ':*'];
          @endphp
          <x-form.label :name="$__f6['name']" :value="$__f6['value']" />
          @php
          $__f7 = ['name' => 'banco', 'list' => ['' => 'Selecione uma conta bancária'] + $banks->pluck('info', 'id')->all(), 'selected' => $padrao ? $padrao->id : '', 'options' => ['id' => 'banco', 'class' => 'form-control select2', 'required']];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f8 = ['name' => 'numero', 'value' => 'Nº do boleto' . '*:'];
          @endphp
          <x-form.label :name="$__f8['name']" :value="$__f8['value']" />
          @php
          $__f9 = ['name' => 'numero', 'value' => old('numero'), 'options' => ['class' => 'form-control', 'required', 'placeholder' => 'Nº do boleto', 'data-mask="00000000"' ]];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f10 = ['name' => 'numero_documento', 'value' => 'Nº do documento' . '*:'];
          @endphp
          <x-form.label :name="$__f10['name']" :value="$__f10['value']" />
          @php
          $__f11 = ['name' => 'numero_documento', 'value' => old('numero_documento'), 'options' => ['class' => 'form-control', 'required', 'placeholder' => 'Nº do documento', 'data-mask="00000000"' ]];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f12 = ['name' => 'carteira', 'value' => 'Carteira' . '*:'];
          @endphp
          <x-form.label :name="$__f12['name']" :value="$__f12['value']" />
          @php
          $__f13 = ['name' => 'carteira', 'value' => $padrao ? $padrao->carteira : '', 'options' => ['class' => 'form-control', 'required', 'placeholder' => 'Carteira' ]];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f14 = ['name' => 'convenio', 'value' => 'Convênio' . '*:'];
          @endphp
          <x-form.label :name="$__f14['name']" :value="$__f14['value']" />
          @php
          $__f15 = ['name' => 'convenio', 'value' => $padrao ? $padrao->convenio : '', 'options' => ['class' => 'form-control', 'required', 'placeholder' => 'Convênio', 'minlength' => '4']];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f16 = ['name' => 'juros', 'value' => 'Juros' . '*:'];
          @endphp
          <x-form.label :name="$__f16['name']" :value="$__f16['value']" />
          @php
          $__f17 = ['name' => 'juros', 'value' => $padrao ? $padrao->juros : '', 'options' => ['class' => 'form-control money', 'required', 'placeholder' => 'Juros' ]];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f18 = ['name' => 'multa', 'value' => 'Multa' . '*:'];
          @endphp
          <x-form.label :name="$__f18['name']" :value="$__f18['value']" />
          @php
          $__f19 = ['name' => 'multa', 'value' => $padrao ? $padrao->multa : '', 'options' => ['class' => 'form-control money', 'required', 'placeholder' => 'Multa' ]];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f20 = ['name' => 'juros_apos', 'value' => 'Juros após (dias)' . '*:'];
          @endphp
          <x-form.label :name="$__f20['name']" :value="$__f20['value']" />
          @php
          $__f21 = ['name' => 'juros_apos', 'value' => $padrao ? $padrao->juros_apos : '', 'options' => ['class' => 'form-control money', 'required', 'placeholder' => 'Juros após (dias)' ]];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f22 = ['name' => 'tipo', 'value' => 'Tipo' . ':'];
          @endphp
          <x-form.label :name="$__f22['name']" :value="$__f22['value']" />
          @php
          $__f23 = ['name' => 'tipo', 'list' => ['Cnab400' => 'Cnab400', 'Cnab240' => 'Cnab240'], 'selected' => $padrao ? $padrao->tipo : '', 'options' => ['id' => 'tipo', 'class' => 'form-control', 'required']];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          @php
          $__f24 = ['name' => 'logo', 'value' => 'Usar logo' . ':'];
          @endphp
          <x-form.label :name="$__f24['name']" :value="$__f24['value']" />
          @php
          $__f25 = ['name' => 'logo', 'list' => ['0' => 'Não', '1' => 'Sim'], 'selected' => '', 'options' => ['id' => 'logo', 'class' => 'form-control', 'required']];
          @endphp
      ...
      <div class="col-md-2 div-aux" style="display: none">
        <div class="form-group">
          @php
          $__f26 = ['name' => 'posto', 'value' => 'Posto' . '*:'];
          @endphp
          <x-form.label :name="$__f26['name']" :value="$__f26['value']" />
          @php
          $__f27 = ['name' => 'posto', 'value' => $padrao ? $padrao->posto : '', 'options' => ['class' => 'form-control', 'placeholder' => 'Posto' ]];
          @endphp
      ...
      <div class="col-md-2 div-aux" style="display: none">
        <div class="form-group">
          @php
          $__f28 = ['name' => 'codigo_cliente', 'value' => 'Cód. Cliente' . '*:'];
          @endphp
          <x-form.label :name="$__f28['name']" :value="$__f28['value']" />
          @php
          $__f29 = ['name' => 'codigo_cliente', 'value' => $padrao ? $padrao->codigo_cliente : '', 'options' => ['class' => 'form-control', 'placeholder' => 'Cód. Cliente' ]];
          @endphp
