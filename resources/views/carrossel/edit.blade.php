...
<section class="content">
  @php
  $__f1 = ['options' => ['url' => action('CarrosselController@update', [$carrossel->id]), 'method' => 'PUT', 'id' => 'carrossel_add_form', 'files' => true ]];
  @endphp
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          @php
          $__f3 = ['name' => 'titulo', 'value' => $carrossel->titulo, 'options' => ['class' => 'form-control', 'placeholder' => 'Título' ]];
          @endphp
      ...
      <div class="col-md-2">
        <div class="form-group">
          ...
          @php
          $__f5 = ['name' => 'nome_botao', 'value' => $carrossel->nome_botao, 'options' => ['class' => 'form-control', 'placeholder' => 'Nome botão' ]];
          @endphp
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          @php
          $__f7 = ['name' => 'link_acao', 'value' => $carrossel->link_acao, 'options' => ['class' => 'form-control', 'placeholder' => 'Link ação' ]];
          @endphp
      ...
      <div class="col-md-10">
        <div class="form-group">
          ...
          @php
          $__f9 = ['name' => 'descricao', 'value' => $carrossel->descricao, 'options' => ['class' => 'form-control', 'placeholder' => 'Descrição' ]];
          @endphp
